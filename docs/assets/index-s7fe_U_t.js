import{_ as n}from"./index-DERpL5lQ.js";import{g as p,l as f}from"./index-CR6nI8OS.js";import{_ as g,s as m,o,c as s,F as b,f as v,h as r,w as u,u as x,i as y}from"./index-D7Q_uCMS.js";import"./index-ClJLQ0Lc.js";const k={class:"iframe-box jsx-comp"},j={__name:"index",setup(D){const a={ifCode:`<script setup>
let data = [
  {
    title: '热销排行',
    goodsData: [
...
</template>`},c=p("learn.jsxComp"),i=m([]);return i.value=c.map(e=>({...e,model:a[e.name+"Code"],component:Object.freeze(f.value[e.name])})),(e,O)=>{const d=n;return o(),s("div",k,[(o(!0),s(b,null,v(x(i),t=>(o(),r(d,{key:t.name,title:t.title,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",modelValue:t.model,"onUpdate:modelValue":l=>t.model=l,type:"vue",height:"600",disabled:"",column:""},{default:u(()=>[(o(),r(y(t.component)))]),_:2},1032,["title","modelValue","onUpdate:modelValue"]))),128))])}}},w=g(j,[["__scopeId","data-v-b9ce68e2"]]);export{w as default};
