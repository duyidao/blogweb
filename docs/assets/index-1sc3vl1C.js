define(["exports","./index-kY_zZjMK","./effect-DvRdfHYc","./index-DzAEJEV-","./vender-qwA9zub-","./index-uafER6--"],function(a,m,l,n,e,u){"use strict";const s=e.defineComponent({name:"瀑布流"}),p={__name:"index",setup(g){const i={flexCode:`<template>
