import{_ as C}from"./index-BsB2aqRq.js";import{c as g}from"./effect-BiOrmKEt.js";import{_ as S}from"./index-BjFss_R6.js";import{_ as $,R as F,r as v,v as w,y as j,T as l,P as y,o as x,h as I,u as _,w as A,j as M}from"./index-DBcL6Esc.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=F(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
...
onUnmounted(() => {
  clearInterval(timer.value);
  timer.value = null;
});`]}),y(()=>{g.value=[""]}),(n,r)=>{const a=C;return x(),I(a,{title:"饼图轮播"},{default:A(()=>[M(z,{data:_(p)},null,8,["data"])]),_:1})}}};export{H as default};
