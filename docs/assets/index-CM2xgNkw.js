import{_}from"./index-BncObdK2.js";import{_ as v}from"./index-DECWDsb4.js";import{c as f}from"./effect-vUu9Uqgv.js";import{_ as h,r as s,q as b,M as x,o as w,c as z,j as u,w as R,a as n,D as p,u as i}from"./index-iiNFdt9r.js";import"./index-HFJ3mj5-.js";import"./rem-DTVwtWVW.js";const I={class:"iframe-box box"},C={class:"compress-upload"},U={class:"info"},D=["src"],F={__name:"index",setup(B){const c=s(""),o=s({size:0,blobsize:0}),a=s(null),r=s(null),g=m=>{let t=new FileReader;t.readAsDataURL(m),t.onload=l=>{c.value=t.result,o.value.size=l.total;let e=document.createElement("canvas");setTimeout(()=>{e.height=a.value.height,e.width=a.value.width,r.value.appendChild(e),e.getContext("2d").drawImage(a.value,0,0,a.value.width,a.value.height),e.toBlob(d=>{o.value.blobsize=d.size,new FormData().append("file",d)},"image/jpeg",.4)},1e3)}};return b(()=>{f.value=[`const imgUrl = ref('')
  const imgInfo = ref({
    size: 0,
    blobsize: 0
  })
