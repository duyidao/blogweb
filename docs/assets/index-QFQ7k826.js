import{_ as C}from"./index-CH3XRMZB.js";import{c as g}from"./effect-DAxamVcs.js";import{_ as S}from"./index-BMsoRHtk.js";import{_ as $,P as F,r as v,q as w,x as j,R as l,N as y,o as x,h as I,u as _,w as A,j as M}from"./index--JrBPAag.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=F(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
