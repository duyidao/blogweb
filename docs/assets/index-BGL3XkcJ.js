import{_ as p}from"./index-B8RXTCpO.js";import{_ as f,g as u,s as m,L as g,o,c as n,F as v,f as _,h as r,w as h,i as R,u as b}from"./index-BBrB8Wc1.js";import"./index-DNkMyw-j.js";import"./index-KyJbnpjc.js";const x={class:"iframe-box"},C={__name:"index",setup(y){const l={addTextCode:`<template>
...
<\/script>`},s=e=>{switch(e){case"addText":return"400";case"notCopy":case"paste":return"200";default:return"300"}},c=u("js.clipboard"),a=m([]);return a.value=c.map(e=>({...e,model:l[e.name+"Code"],component:Object.freeze(g.value[e.name]),height:s(e.name)})),(e,L)=>{const i=p;return o(),n("div",x,[(o(!0),n(v,null,_(b(a),t=>(o(),r(i,{key:t.name,title:t.title,modelValue:t.model,"onUpdate:modelValue":d=>t.model=d,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",type:"vue",height:t.height,disabled:""},{default:h(()=>[(o(),r(R(t.component)))]),_:2},1032,["title","modelValue","onUpdate:modelValue","height"]))),128))])}}},E=f(C,[["__scopeId","data-v-28f7f9e8"]]);export{E as default};
