import{_ as f}from"./index-BbQMhX4Q.js";import{_ as v}from"./index-VOCHQR9C.js";import{_ as g,r as s,q as p,M as w,o as x,c as R,j as c,w as C,a as t,E as u,u as d,B as U,Q as I}from"./index-CcjIZO8g.js";import{c as _}from"./effect-DmMT9RI3.js";import"./index-BisnD9HM.js";import"./rem-DwsRrOGD.js";const k={class:"iframe-box box"},B={class:"tailor"},F={class:"tailor-upload"},y=["src"],D={__name:"index",setup(L){const o=s(""),i=s(null),e=s(null),m=r=>{let a=new FileReader;a.readAsDataURL(r),a.onload=()=>{o.value=a.result;let n=i.value.getContext("2d");setTimeout(()=>{let l=100/e.value.height*e.value.naturalHeight,h=200/e.value.width*e.value.naturalWidth;n.drawImage(e.value,0,0,h,l,0,0,200,100)},1e3)}};return p(()=>{_.value=[`const onChangeFn = e => {
  // 预览文件
