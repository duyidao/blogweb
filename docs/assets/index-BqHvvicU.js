import{_ as d}from"./index-DoVh_sxX.js";import{_ as f,r as t,o as c,k as _,w as m,u as n,i as y,a as p,O as v,c as b,A as k,V as C}from"./index-oMvnDw21.js";const w={__name:"index",setup(x){const e=t(""),l=t(null),u=()=>{if(!window.EyeDropper){e.value="你的浏览器不支持 EyeDropper API",l.value.style.backgroundColor="#000";return}e.value="正在打开拾色器，请稍等...";const s=new EyeDropper,r=new AbortController;s.open({signal:r.signal}).then(o=>{e.value=o.sRGBHex,l.value.style.backgroundColor=o.sRGBHex}).catch(o=>{e.value=o})},a=t(`const clickFn = () => {
  // 判断浏览器是否支持
