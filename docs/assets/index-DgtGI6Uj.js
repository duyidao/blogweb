import{_ as d}from"./index-BdOZFrXQ.js";import{_ as f,r as a,o as c,h as m,w as _,a as p,C as y,u as n,c as v,D as b,M as C,k}from"./index-DiqVLKRI.js";import"./index-DInM1XT0.js";import"./index-oockyxCU.js";const w={__name:"index",setup(x){const e=a(""),l=a(null),u=()=>{if(!window.EyeDropper){e.value="你的浏览器不支持 EyeDropper API",l.value.style.backgroundColor="#000";return}e.value="正在打开拾色器，请稍等...";const s=new EyeDropper,r=new AbortController;s.open({signal:r.signal}).then(o=>{e.value=o.sRGBHex,l.value.style.backgroundColor=o.sRGBHex}).catch(o=>{e.value=o})},t=a(`const clickFn = () => {
  // 判断浏览器是否支持
