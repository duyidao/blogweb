...
[04:52.899]`,Pe="/blogweb/assets/likeme-BI0z1bw6.mp3",ze=`[00:00.000] 作词 : 毛不易
[00:01.000] 作曲 : 毛不易
[00:02.000] 编曲 : 赵兆/宋涛
[00:03.000] 制作人 : 李健/赵兆
[00:09.840]
...
[03:27.421] 制作发行 : 哇唧唧哇
`,Ge="/blogweb/assets/peter-BVhB60oM.mp3",Je="/blogweb/assets/shape-Dr8ic4LH.mp3",Ee="/blogweb/assets/so_far_away-CPeEg5z6.mp3",Fe=`[00:00.00]So Far Away - Martin Garrix/David Guetta/Jamie Scott/Romy Dya
...
[02:58.53]When you're so far away`,Ye="/blogweb/assets/so%20far%20away-Dl1oEphr.webp",Ne="/blogweb/assets/something-CLtHNr96.mp3",Re=`[ml:1.0]
...
[03:56.044]我想要的不过是这些
[03:56.044]`,Ve="/blogweb/assets/something-f5Ei2QHr.webp",qe={__name:"music",setup(l){const a=i(null),o=i(null);return T(()=>{o.value=new APlayer({container:a.value,lrcType:1,theme:$.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:Me,lrc:Ae,cover:R},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:Ge,cover:q},{name:"Shape of You",artist:"Ed Sheeran",url:Je,cover:V},{name:"像我这样的人",artist:"毛不易",url:Pe,lrc:ze,cover:N},{name:"So far away",artist:"Martin Garrix",url:Ee,lrc:Fe,cover:Ye},{name:"Something just like this",artist:"The Chainsmokers",url:Ne,lrc:Re,cover:Ve}]})}),E(()=>$.value,()=>{o.value.audio.theme=$.value?"#fff":"#555"}),(h,w)=>(p(),v("div",{ref_key:"musicRef",ref:a,class:"home-music"},null,512))}},Qe=C(qe,[["__scopeId","data-v-fb87f208"]]),Ue={class:"home"},Xe={class:"msg"},Ke={class:"play"},Ze={class:"box"},e0={class:"home-candle"},a0={class:"home-time"},o0={__name:"index",setup(l){const a=i(null),o=i(""),h=i(""),w=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],_=i("");return T(()=>{let n=new Date;const r=n.getDay();o.value=n.getFullYear()+"-"+("0"+(n.getMonth()+1)).slice(-2)+"-"+("0"+n.getDate()).slice(-2),_.value=w[r];const b=()=>{n=new Date;const I=("0"+n.getHours()).slice(-2),g=("0"+n.getMinutes()).slice(-2),S=("0"+n.getSeconds()).slice(-2);h.value=I+":"+g+":"+S};b(),a.value=setInterval(()=>{b()},1e3)}),H(()=>{clearInterval(a.value)}),(n,r)=>(p(),v("div",Ue,[D(He,{class:"user"}),e("div",Xe,[D(Te),e("div",Ke,[e("div",Ze,[e("div",e0,[D(Y)]),e("div",a0,[e("span",null,t(d(o)),1),e("span",null,t(d(_)),1),e("span",null,t(d(h)),1)])]),D(Qe)])])]))}},u0=C(o0,[["__scopeId","data-v-7435f903"]]);export{u0 as default};
