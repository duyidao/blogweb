import{_ as p}from"./index-C8SelH6X.js";import{g as f,s as u,U as m,o,c as n,F as g,j as v,k as r,w as h,u as _,l as R}from"./index-B4bBUjY3.js";import"./index-CKO9WkJI.js";const b={class:"iframe-box"},L={__name:"index",setup(C){const l={addTextCode:`<template>
...
<\/script>`},s=e=>{switch(e){case"addText":return"400";case"notCopy":case"paste":return"200";default:return"300"}},c=f("js.clipboard"),a=u([]);return a.value=c.map(e=>({...e,model:l[e.name+"Code"],component:Object.freeze(m.value[e.name]),height:s(e.name)})),(e,x)=>{const i=p;return o(),n("div",b,[(o(!0),n(g,null,v(_(a),t=>(o(),r(i,{key:t.name,title:t.title,modelValue:t.model,"onUpdate:modelValue":d=>t.model=d,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",type:"vue",height:t.height,disabled:""},{default:h(()=>[(o(),r(R(t.component)))]),_:2},1032,["title","modelValue","onUpdate:modelValue","height"]))),128))])}}};export{L as default};
