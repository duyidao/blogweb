define(["exports","./index-fE1ZY-zZ","./index-DdK_kEZy","./compress-CsfBFKni","./effect-CbHB8Sih","./index-BfVzJLus","./vender-CF49NVAq","./index-BSjz60gr","./rem-Cqtq43AX"],function(c,g,_,h,d,x,e,U,j){"use strict";var m=document.createElement("style");m.textContent=`.compress[data-v-de6fd2ea]{display:flex;flex-direction:column;align-items:center;width:100%}.compress .compress-upload[data-v-de6fd2ea],.compress img[data-v-de6fd2ea]{width:300px}.compress .info[data-v-de6fd2ea]{display:flex;align-items:center;justify-content:space-evenly;width:100%;color:var(--primary-info);margin:40px 0 20px}.compress .info .info-item[data-v-de6fd2ea]{display:flex;flex-direction:column;align-items:center;flex:1}.compress .info .info-item span[data-v-de6fd2ea]{font-size:16px;font-family:sans;margin-bottom:15px}.compress .info .info-item span.click[data-v-de6fd2ea]{color:red;border-bottom:1px solid red;padding-bottom:4px;cursor:pointer}@media screen and (max-width: 768px){.compress .compress-upload[data-v-de6fd2ea],.compress img[data-v-de6fd2ea]{width:18.75rem}.compress .info[data-v-de6fd2ea]{flex-direction:column;margin:2.5rem 0 0}.compress .info .info-item[data-v-de6fd2ea]{margin-bottom:1.25rem}.compress .info .info-item span[data-v-de6fd2ea]{font-size:1.25rem;margin-bottom:.9375rem}.compress .info .info-item span.click[data-v-de6fd2ea]{border-bottom-width:.0625rem;padding-bottom:.25rem}}
