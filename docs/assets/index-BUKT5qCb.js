define(["exports","./index-DlgzzseR","./vender-CF49NVAq","./index-BfVzJLus","./index-GPVW21Ic","./rem-Cqtq43AX","./index-BSjz60gr"],function(a,i,e,p,_,b,g){"use strict";var s=document.createElement("style");s.textContent=`.spanRef[data-v-7d9d563b]{display:flex;justify-content:center;align-items:center;width:100%;height:3.125rem;border-radius:1rem;margin-top:1.25rem}.spanRef span[data-v-7d9d563b]{font-size:13px;color:#fff;mix-blend-mode:difference}
