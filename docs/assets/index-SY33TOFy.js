import{_ as b}from"./index-lqaWdkyv.js";import{c as g}from"./effect-CPvDC59a.js";import{_ as S}from"./index-Bf-8kDCZ.js";import{u as $}from"./rem-B0h-CM2v.js";import{_ as F,s as l}from"./index-R7MN-9XR.js";import{r as v,C as w,A,P as y,o as x,B as I,u as _,s as M,q as W}from"./vender-CcOEkWCz.js";const j={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=$(),m=v({}),C=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
...
{car|`+n.data[0].name+n.data[0].flowValue+"辆}",rich:{title:{fontFamily:"sans",fontSize:l.value>768?30:30*a.value,color:"#999",lineHeight:l.value>768?50:50*a.value,fontWeight:500,letterSpace:l.value>768?1.5:1.5*a.value},car:{fontFamily:"sans",fontSize:l.value>768?16:16*a.value,color:"#999",lineHeight:l.value>768?40:40*a.value,fontWeight:500,letterSpace:l.value>768?1.5:1.5*a.value}}},emphasis:{show:!0}},emphasis:{label:{show:!1,fontSize:l.value>768?20:20*a.value,fontWeight:"bold"}},labelLine:{show:!1},data:n.data}]}},i=v(null),u=v(0),d=v(-1),f=()=>{i.value&&(clearInterval(i.value),i.value=null);const e=()=>{if(!o.value)return;o.value.myChart.dispatchAction({type:"highlight",seriesIndex:0,dataIndex:u.value}),o.value.myChart.dispatchAction({type:"downplay",seriesIndex:0,dataIndex:d.value});const t=n.data[u.value];m.value.series[0].label.normal.formatter="{title|"+t.value+`%}
{car|`+t.name+t.value+"辆}",u.value=u.value>=n.data.length-1?0:u.value+1,d.value=d.value>=n.data.length-1?0:d.value+1};e(),i.value=setInterval(()=>{e()},3e3)},o=v(null),h=()=>{o.value&&(o.value.myChart.on("highlight",function(e){e.name&&(clearInterval(i.value),i.value=null,n.data.forEach((t,s)=>{t.name!==e.name?o.value.myChart.dispatchAction({type:"downplay",seriesIndex:0,dataIndex:s}):m.value.series[0].label.normal.formatter="{title|"+t.value+`%}
{car|`+t.name+t.value+"辆}"}))}),o.value.myChart.on("downplay",function(e){e.name&&f()}))};return w(()=>{f(),h()}),A(()=>[n.data,l.value,a.value],e=>{r.clear(),u.value=0,d.value=-1,C(),f(),h()},{immediate:!0,deep:!0}),y(()=>{clearInterval(i.value),i.value=null}),p({pieChart:o}),(e,t)=>{const s=S;return x(),I(s,{class:"pie_chart",ref_key:"pieChart",ref:o,option:_(m)},null,8,["option"])}}},z=F(j,[["__scopeId","data-v-17bcb147"]]),B={__name:"index",setup(c){const p=v([{value:90,name:"货车通行",flowValue:"90%",flowName:"货车车流量"},{value:10,name:"其他车通行",flowValue:"10%",flowName:"其他车车流量"}]);return setTimeout(()=>{p.value=[{value:40,name:"货车通行",flowValue:"40%",flowName:"货车车流量"},{value:50,name:"其他车通行",flowValue:"50%",flowName:"其他车车流量"},{value:10,name:"客车通行",flowValue:"10%",flowName:"客车车流量"}]},5e3),w(()=>{g.value=[`const props = defineProps({
  data: {
    type: Array,
    default: () => ([]),
  },
...
onUnmounted(() => {
  clearInterval(timer.value);
  timer.value = null;
});`]}),y(()=>{g.value=[""]}),(n,r)=>{const a=b;return x(),I(a,{title:"饼图轮播"},{default:M(()=>[W(z,{data:_(p)},null,8,["data"])]),_:1})}}};export{B as default};
