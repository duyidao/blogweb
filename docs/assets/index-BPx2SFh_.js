...
}`,V={__name:"index",setup(s){const t=f("daodao"),a=f(11);return(r,e)=>{const i=x;return g(),y(i,{title:"input组件封装",column:"",modelValue:v,"onUpdate:modelValue":e[3]||(e[3]=n=>v=n),disabled:"",buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",height:"420",class:"input-info"},{default:b(()=>[o("div",w,[o("span",N,"文本输入框，父组件内容 "+c(u(t)),1),m(d,{msg:u(t),"onUpdate:msg":e[0]||(e[0]=n=>p(t)?t.value=n:null)},null,8,["msg"])]),o("div",S,[o("span",A,"多行文本框，父组件内容 "+c(u(t)),1),m(d,{type:"textarea",msg:u(t),"onUpdate:msg":e[1]||(e[1]=n=>p(t)?t.value=n:null)},null,8,["msg"])]),o("div",C,[o("span",I,"数字框，父组件内容 "+c(u(a)),1),m(d,{type:"number",msg:u(a),"onUpdate:msg":e[2]||(e[2]=n=>p(a)?a.value=n:null)},null,8,["msg"])])]),_:1})}}},D=_(V,[["__scopeId","data-v-bcfe5215"]]);export{D as default};
