import{_ as d}from"./index-WJxHECEO.js";import{_ as f,r as n,o as p,h as m,w as _,a as c,C as y,u as l,c as b,D as v,L as w,k as g}from"./index-zM3bxknP.js";import"./index-FKu__HeA.js";import"./rem-r5RkVmd6.js";import"./index-DmRA0QTM.js";const C="/blogweb/assets/eyeDropper-BE1GK83Q.png",k={__name:"index",setup(D){const e=n(""),t=n(null),u=()=>{if(!window.EyeDropper){e.value="你的浏览器不支持 EyeDropper API",t.value.style.backgroundColor="#000";return}e.value="正在打开拾色器，请稍等...";const s=new EyeDropper,r=new AbortController;s.open({signal:r.signal}).then(o=>{e.value=o.sRGBHex,t.value.style.backgroundColor=o.sRGBHex}).catch(o=>{e.value=o})},a=n(`const clickFn = () => {
  // 判断浏览器是否支持
