...
[04:52.899]`,j0="/blogweb/assets/likeme-BI0z1bw6.mp3",M0=`[00:00.000] 作词 : 毛不易
[00:01.000] 作曲 : 毛不易
[00:02.000] 编曲 : 赵兆/宋涛
[00:03.000] 制作人 : 李健/赵兆
[00:09.840]
...
[03:27.421] 制作发行 : 哇唧唧哇
`,z0="/blogweb/assets/peter-BVhB60oM.mp3",J0="/blogweb/assets/shape-Dr8ic4LH.mp3",P0="/blogweb/assets/so_far_away-CPeEg5z6.mp3",G0=`[00:00.00]So Far Away - Martin Garrix/David Guetta/Jamie Scott/Romy Dya
...
[02:58.53]When you're so far away`,F0="/blogweb/assets/so%20far%20away-Dl1oEphr.webp",E0="/blogweb/assets/something-CLtHNr96.mp3",N0=`[ml:1.0]
...
[03:56.044]我想要的不过是这些
[03:56.044]`,Y0="/blogweb/assets/something-f5Ei2QHr.webp",R0={__name:"music",setup(w){const a=i(null),t=i(null);return D(()=>{t.value=new APlayer({container:a.value,lrcType:1,theme:$.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:A0,lrc:H0,cover:R},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:z0,cover:q},{name:"Shape of You",artist:"Ed Sheeran",url:J0,cover:V},{name:"像我这样的人",artist:"毛不易",url:j0,lrc:M0,cover:Y},{name:"So far away",artist:"Martin Garrix",url:P0,lrc:G0,cover:F0},{name:"Something just like this",artist:"The Chainsmokers",url:E0,lrc:N0,cover:Y0}]})}),F(()=>$.value,()=>{t.value.audio.theme=$.value?"#fff":"#555"}),(u,p)=>(y(),v("div",{ref_key:"musicRef",ref:a,class:"home-music"},null,512))}},V0=x(R0,[["__scopeId","data-v-fb87f208"]]),q0={class:"home"},U0={class:"msg"},Q0={class:"play"},K0={class:"box"},X0={class:"home-candle"},Z0={class:"home-time"},ee={__name:"index",setup(w){const a=i(null),t=i(""),u=i(""),p=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],_=i("");return D(()=>{let d=new Date;const r=d.getDay();t.value=d.getFullYear()+"-"+("0"+(d.getMonth()+1)).slice(-2)+"-"+("0"+d.getDate()).slice(-2),_.value=p[r];const b=()=>{d=new Date;const I=("0"+d.getHours()).slice(-2),h=("0"+d.getMinutes()).slice(-2),S=("0"+d.getSeconds()).slice(-2);u.value=I+":"+h+":"+S};b(),a.value=setInterval(()=>{b()},1e3)}),H(()=>{clearInterval(a.value)}),(d,r)=>(y(),v("div",q0,[T(O0,{class:"user"}),e("div",U0,[T(S0),e("div",Q0,[e("div",K0,[e("div",X0,[T(N)]),e("div",Z0,[e("span",null,c(o(t)),1),e("span",null,c(o(_)),1),e("span",null,c(o(u)),1)])]),T(V0)])])]))}},ie=x(ee,[["__scopeId","data-v-7435f903"]]);export{ie as default};
