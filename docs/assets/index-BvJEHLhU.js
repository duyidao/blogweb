...
}`]}),b(()=>{h.value=[""]}),(i,n)=>{const r=x;return g(),F(r,{title:"input组件封装",class:"input-info"},{default:B(()=>[o("div",w,[o("span",A,"文本输入框，父组件内容 "+c(u(e)),1),m(d,{msg:u(e),"onUpdate:msg":n[0]||(n[0]=l=>p(e)?e.value=l:null)},null,8,["msg"])]),o("div",I,[o("span",C,"多行文本框，父组件内容 "+c(u(e)),1),m(d,{type:"textarea",msg:u(e),"onUpdate:msg":n[1]||(n[1]=l=>p(e)?e.value=l:null)},null,8,["msg"])]),o("div",U,[o("span",V,"数字框，父组件内容 "+c(u(t)),1),m(d,{type:"number",msg:u(t),"onUpdate:msg":n[2]||(n[2]=l=>p(t)?t.value=l:null)},null,8,["msg"])])]),_:1})}}},D=_(E,[["__scopeId","data-v-8b39e8e9"]]);export{D as default};
