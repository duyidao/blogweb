import{_ as i}from"./index-GrhpAljX.js";import{c as l}from"./effect-BKCwPZM9.js";import{g as f,j as d}from"./index-jA4j3-G_.js";import{_ as p,s as m,q as x,M as _,o as t,c as r,F as h,f as w,h as c,w as b,i as v,u as C}from"./index-DiFe4JqO.js";const F={class:"iframe-box xlsx-word"},g={__name:"index",setup(k){const n={xlsxCode:`import { read, utils } from "xlsx";
...
}`},s=f("js.xlsxAndWord"),a=m([]);return a.value=s.map(e=>({...e,model:n[e.name+"Code"],component:Object.freeze(d.value[e.name])})),x(()=>{l.value=s.map(e=>({name:e.title+"源码",value:n[e.name+"Code"]}))}),_(()=>{l.value=[""]}),(e,D)=>{const u=i;return t(),r("div",F,[(t(!0),r(h,null,w(C(a),o=>(t(),c(u,{key:o.name,title:o.title},{default:b(()=>[(t(),c(v(o.component)))]),_:2},1032,["title"]))),128))])}}},y=p(g,[["__scopeId","data-v-0617c926"]]);export{y as default};
