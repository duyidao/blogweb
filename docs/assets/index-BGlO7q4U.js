import{_ as d}from"./index-CiDxO_TV.js";import{r as n,o as p,B as m,s as f,b as c,w as _,u as l,a as y,t as b,d as v,x as w}from"./vender-n0v3V56A.js";import{_ as g}from"./index-u6hWLH6A.js";import"./index-CW0A1Wek.js";import"./rem-DGH0fGf2.js";import"./index-DBTfGxA4.js";const C="/blogweb/assets/eyeDropper-BE1GK83Q.png",k={__name:"index",setup(x){const e=n(""),t=n(null),u=()=>{if(!window.EyeDropper){e.value="你的浏览器不支持 EyeDropper API",t.value.style.backgroundColor="#000";return}e.value="正在打开拾色器，请稍等...";const s=new EyeDropper,r=new AbortController;s.open({signal:r.signal}).then(o=>{e.value=o.sRGBHex,t.value.style.backgroundColor=o.sRGBHex}).catch(o=>{e.value=o})},a=n(`const clickFn = () => {
  // 判断浏览器是否支持
