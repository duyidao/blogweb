import{_ as O}from"./index-DERpL5lQ.js";import{_ as k}from"./index-RQ--UWLt.js";import{_ as R,r,o as v,h as N,w as V,u as m,k as B,j as T,a as c,c as F,N as S,p as U,d as D}from"./index-D7Q_uCMS.js";import"./index-ClJLQ0Lc.js";const b=n=>(U("data-v-4eab2deb"),n=n(),D(),n),H={class:"box"},L={class:"box-item"},W=b(()=>c("p",null,"未压缩",-1)),G=["src"],M={class:"box-item"},Y=b(()=>c("p",null,"压缩后",-1)),A=["src"],$={__name:"index",props:{quality:{type:Number,default:90}},emits:["update:quality"],setup(n,{emit:C}){const g=n,j=C,I=r(null);let s=r({});const w={"image/jpeg":"image/jpeg","image/jpg":"image/jpg"},x=e=>{if(s.value=e,!s.value||!w[s.value.type])return h(),alert("请选择正确格式的图片");if(s.value.type==="image/png")return h(),alert("png格式的图片暂不适用");E(s.value)},i=r(""),l=r(""),u=new FileReader,E=e=>{e instanceof File&&(u.onload=async()=>{i.value=u.result,await q({imgSrc:i.value,type:e.type}),console.log("originImgSrc.value",i.value.length,"compressedImgSrc.value",l.value.length)},u.readAsDataURL(e))},q=({imgSrc:e,type:a})=>{const t=document.createElement("canvas"),o=document.createElement("img"),d=t.getContext("2d");return o.src=e,new Promise(P=>{o.onload=()=>{const y=o.width,f=o.height;t.width=y,t.height=f,d.drawImage(o,0,0,y,f),_(t,e,a),P(!0)}})},_=(e,a,t)=>{l.value=e.toDataURL(t,g.quality/100),l.value.length>=a.length&&g.quality>=10&&(j("update:quality",g.quality-10),_(e,a,t))},h=()=>{I.value.value="",s.value=null,l.value="",i.value=""},p=r(`const props = defineProps({
  // 压缩质量
  quality: {
    type: Number,
    default: 90,
...
const setImgFileEmptyFn = () => {
  ...
  originImgSrc.value = ''
}`);return(e,a)=>{const t=k,o=O;return v(),N(o,{title:"图片压缩",subtitle:"请选择jpg格式图片",class:"iframe-box",buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",column:"",type:"javascript",modelValue:m(p),"onUpdate:modelValue":a[0]||(a[0]=d=>B(p)?p.value=d:null),disabled:""},{default:V(()=>[T(t,{id:"imgFile",placeholder:"请选择图片",ref_key:"imgFile",ref:I,onChange:x},null,512),c("div",H,[c("div",L,[W,m(i)?(v(),F("img",{key:0,src:m(i),title:"未压缩",alt:"未压缩"},null,8,G)):S("",!0)]),c("div",M,[Y,m(l)?(v(),F("img",{key:0,src:m(l),title:"压缩后",alt:"压缩后"},null,8,A)):S("",!0)])])]),_:1},8,["modelValue"])}}},X=R($,[["__scopeId","data-v-4eab2deb"]]);export{X as default};
