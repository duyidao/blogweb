import{_ as f}from"./index-BncObdK2.js";import{_ as v}from"./index-DECWDsb4.js";import{_ as g,r as s,q as p,M as R,o as w,c as x,j as c,w as C,a as t,E as u,u as d,B as U,R as I}from"./index-iiNFdt9r.js";import{c as _}from"./effect-vUu9Uqgv.js";import"./index-HFJ3mj5-.js";import"./rem-DTVwtWVW.js";const k={class:"iframe-box box"},B={class:"tailor"},F={class:"tailor-upload"},y=["src"],D={__name:"index",setup(L){const o=s(""),i=s(null),e=s(null),m=r=>{let a=new FileReader;a.readAsDataURL(r),a.onload=()=>{o.value=a.result;let n=i.value.getContext("2d");setTimeout(()=>{let l=100/e.value.height*e.value.naturalHeight,h=200/e.value.width*e.value.naturalWidth;n.drawImage(e.value,0,0,h,l,0,0,200,100)},1e3)}};return p(()=>{_.value=[`const onChangeFn = e => {
  // 预览文件
