import{_ as O}from"./index-DjaZ8iea.js";import{_ as k}from"./index-C6sBqCeB.js";import{_ as R,r,o as v,k as V,w as B,u as m,i as N,e as T,a as c,c as F,V as S,p as U,d as D}from"./index-BoT65t34.js";import"./index-_vRuoRk1.js";const b=n=>(U("data-v-08019a3a"),n=n(),D(),n),H={class:"box"},L={class:"box-item"},W=b(()=>c("p",null,"未压缩",-1)),G=["src"],M={class:"box-item"},Y=b(()=>c("p",null,"压缩后",-1)),A=["src"],$={__name:"index",props:{quality:{type:Number,default:90}},emits:["update:quality"],setup(n,{emit:w}){const g=n,C=w,I=r(null);let i=r({});const j={"image/jpeg":"image/jpeg","image/jpg":"image/jpg"},x=e=>{if(i.value=e,!i.value||!j[i.value.type])return h(),alert("请选择正确格式的图片");if(i.value.type==="image/png")return h(),alert("png格式的图片暂不适用");E(i.value)},s=r(""),l=r(""),u=new FileReader,E=e=>{e instanceof File&&(u.onload=async()=>{s.value=u.result,await q({imgSrc:s.value,type:e.type}),console.log("originImgSrc.value",s.value.length,"compressedImgSrc.value",l.value.length)},u.readAsDataURL(e))},q=({imgSrc:e,type:a})=>{const t=document.createElement("canvas"),o=document.createElement("img"),d=t.getContext("2d");return o.src=e,new Promise(P=>{o.onload=()=>{const y=o.width,f=o.height;t.width=y,t.height=f,d.drawImage(o,0,0,y,f),_(t,e,a),P(!0)}})},_=(e,a,t)=>{l.value=e.toDataURL(t,g.quality/100),l.value.length>=a.length&&g.quality>=10&&(C("update:quality",g.quality-10),_(e,a,t))},h=()=>{I.value.value="",i.value=null,l.value="",s.value=""},p=r(`const props = defineProps({
  // 压缩质量
  quality: {
    type: Number,
    default: 90,
...
const setImgFileEmptyFn = () => {
  ...
  originImgSrc.value = ''
}`);return(e,a)=>{const t=k,o=O;return v(),V(o,{title:"图片压缩",subtitle:"请选择jpg格式图片",class:"iframe-box",buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",column:"",type:"javascript",modelValue:m(p),"onUpdate:modelValue":a[0]||(a[0]=d=>N(p)?p.value=d:null),disabled:""},{default:B(()=>[T(t,{id:"imgFile",placeholder:"请选择图片",ref_key:"imgFile",ref:I,onChange:x},null,512),c("div",H,[c("div",L,[W,m(s)?(v(),F("img",{key:0,src:m(s),title:"未压缩",alt:"未压缩"},null,8,G)):S("",!0)]),c("div",M,[Y,m(l)?(v(),F("img",{key:0,src:m(l),title:"压缩后",alt:"压缩后"},null,8,A)):S("",!0)])])]),_:1},8,["modelValue"])}}},X=R($,[["__scopeId","data-v-08019a3a"]]);export{X as default};
