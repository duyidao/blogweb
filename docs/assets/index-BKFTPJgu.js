...
[03:56.044]我想要的不过是这些
[03:56.044]`,ee="/blogweb/assets/something-f5Ei2QHr.webp",ae={__name:"music",setup(n){const o=i(null),a=i(null);return k(()=>{a.value=new X({container:o.value,lrcType:1,theme:$.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:R0,lrc:F0,cover:o0},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:V0,cover:n0},{name:"Shape of You",artist:"Ed Sheeran",url:q0,cover:d0},{name:"像我这样的人",artist:"毛不易",url:Y0,lrc:N0,cover:a0},{name:"So far away",artist:"Martin Garrix",url:Q0,lrc:U0,cover:X0},{name:"Something just like this",artist:"The Chainsmokers",url:K0,lrc:Z0,cover:ee}]})}),K(()=>$.value,()=>{a.value.audio.theme=$.value?"#fff":"#555"}),(d,r)=>(w(),v("div",{ref_key:"musicRef",ref:o,class:"home-music"},null,512))}},oe=S(ae,[["__scopeId","data-v-efc38a27"]]),de={class:"home"},ne={class:"msg"},ce={class:"play"},te={class:"box"},se={class:"home-candle"},me={class:"home-time"},ie={__name:"index",setup(n){const o=i(null),a=i(""),d=i(""),r=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],l=i("");return k(()=>{let c=new Date;const y=c.getDay();a.value=c.getFullYear()+"-"+("0"+(c.getMonth()+1)).slice(-2)+"-"+("0"+c.getDate()).slice(-2),l.value=r[y];const _=()=>{c=new Date;const T=("0"+c.getHours()).slice(-2),D=("0"+c.getMinutes()).slice(-2),C=("0"+c.getSeconds()).slice(-2);d.value=T+":"+D+":"+C};_(),o.value=setInterval(()=>{_()},1e3)}),P(()=>{clearInterval(o.value)}),(c,y)=>(w(),v("div",de,[I(J0,{class:"user"}),e("div",ne,[I(O0),e("div",ce,[e("div",te,[e("div",se,[I(e0)]),e("div",me,[e("span",null,s(t(a)),1),e("span",null,s(t(l)),1),e("span",null,s(t(d)),1)])]),I(oe)])])]))}},_e=S(ie,[["__scopeId","data-v-7435f903"]]);export{_e as default};
