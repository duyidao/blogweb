import{_ as l}from"./index-BivA_Czy.js";import{c as n,m as c}from"./effect-NJTD2hZi.js";import{_ as m,r as p,q as _,N as f,o as u,h as v,w as x,a as d,p as h,d as w}from"./index-DQOh_Shd.js";const y=e=>(h("data-v-73fafa3a"),e=e(),w(),e),b=y(()=>d("div",{class:"item"},null,-1)),I=[b],g={__name:"index",setup(e){const o=p(null),a=()=>{var s,t,i;const r=(s=o.value)==null?void 0:s.clientWidth;(i=(t=o.value)==null?void 0:t.style)==null||i.setProperty("--w",r+"px")};return _(()=>{a(),window.addEventListener("resize",()=>{a()}),n.value=[`<script>
const init = () => {
