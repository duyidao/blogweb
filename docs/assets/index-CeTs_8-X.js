import{_}from"./index-CM9OeQjf.js";import{_ as v}from"./index-B1qkeMhi.js";import{c as f}from"./effect-CO1aAAXF.js";import{_ as h,r as n,q as b,M as w,o as x,c as z,j as u,w as I,a as e,D as p,u as l}from"./index-Sw9qLz3T.js";import"./index-CivYiP3p.js";import"./rem-CbSUZWA8.js";const R="/blogweb/assets/compress-DccebSpH.png",C={class:"iframe-box box"},D={class:"compress"},U={class:"compress-upload"},F={class:"info"},B={class:"info-item"},j=["src"],k={__name:"index",setup(y){const c=n(""),a=n({size:0,blobsize:0}),s=n(null),m=n(null),g=r=>{let t=new FileReader;t.readAsDataURL(r),t.onload=i=>{c.value=t.result,a.value.size=i.total;let o=document.createElement("canvas");setTimeout(()=>{o.height=s.value.height,o.width=s.value.width,m.value.appendChild(o),o.getContext("2d").drawImage(s.value,0,0,s.value.width,s.value.height),o.toBlob(d=>{a.value.blobsize=d.size,new FormData().append("file",d)},"image/jpeg",.4)},1e3)}};return b(()=>{f.value=[`const imgUrl = ref('')
const imgInfo = ref({
  size: 0,
  blobsize: 0
})
