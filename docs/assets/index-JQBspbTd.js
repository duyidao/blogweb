import{_ as C}from"./index-D7ONBsjU.js";import{c as g}from"./effect-BFgPyeSK.js";import{_ as S}from"./index-SLFozRSh.js";import{_ as $,Q as F,r as v,v as w,y as j,S as l,O as y,o as x,h as I,u as _,w as A,j as M}from"./index-DnKoH_B6.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=F(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
