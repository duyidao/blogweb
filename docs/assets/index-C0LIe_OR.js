import{_ as C}from"./index-BUXCVPTV.js";import{c as g}from"./effect-DVGDOVIX.js";import{_ as S}from"./index-CEI4rh5l.js";import{u as $}from"./rem-cCMSN3q_.js";import{_ as F,r as v,q as w,x as M,P as l,M as y,o as x,h as I,u as _,w as j,j as A}from"./index-boqNHSKg.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=$(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
