import{_ as L}from"./index-CjhaQ8a5.js";import{_ as M}from"./index-DNiyFe_j.js";import{c as S,m as v}from"./effect-a-JszUgu.js";import{r as n,a4 as z,C as I,P as T,A as j,o as r,a as s,q as w,s as G,b as c,t as _,F as N,v as R,l as P,d as C,u as W,a5 as k}from"./vender-n0v3V56A.js";import{u as X}from"./rem-DGH0fGf2.js";import{_ as O}from"./index-CYKq6d_U.js";const V={class:"line-li-dom"},D={key:0,class:"line-li-dom__chart"},U={key:0,class:"line-li-dom__chart__title"},B={class:"title__name"},q={class:"title__legend"},E={class:"title__legend__item__name"},$={class:"line-li-dom__chart__content"},H={__name:"index",props:{data:{type:Array,default:()=>[{name:"正常运行设备数量",color:"rgb(88, 255, 220)",colorStops:["rgb(88, 255, 220)","rgba(88, 255, 220, 0.1)"],data:[{name:"Mon",value:120},{name:"Tue",value:132},{name:"Wed",value:101},{name:"Thu",value:134},{name:"Fri",value:90},{name:"Sat",value:230},{name:"Sun",value:210}]},{name:"故障清单设备数量",color:"#ef8a3a",colorStops:["#ef8a3a","rgba(88, 255, 220, 0.1)"],data:[{name:"Mon",value:11},{name:"Tue",value:243},{name:"Wed",value:645},{name:"Thu",value:423},{name:"Fri",value:349},{name:"Sat",value:13},{name:"Sun",value:0}]}]},info:{type:Object,default:()=>({titleShow:!0,yName:"单位：台",splitNumber:5,style:{fontColor:"rgba(255, 255, 255, .7)",white:"rgb(255, 255, 255)",transparent:"rgba(255, 255, 255, .0)"}})}},setup(u){const o=u,{ratio:l}=X(),d=n(""),y=n({}),f=n(0),h=n([]),A=()=>{const t=Math.ceil(Math.max(...o.data.map(a=>a.data.map(m=>{const{value:i}=m;return i??m})).flat(),1)),e=Number((t/o.info.splitNumber).toFixed(1));f.value=e>1?Math.ceil(e):e,h.value=o.data[0]?o.data[0].data.map(a=>a.name):[]},x=()=>{var t;A(),y.value={tooltip:{trigger:"axis",axisPointer:{lineStyle:{color:"#fff",width:2,type:"solid"}}},grid:{left:"0",right:"0",bottom:"2%",top:"0",containLabel:!0},xAxis:{type:"category",boundaryGap:!0,offset:0,axisTick:{show:!1},axisLabel:{interval:"auto",formatter:(e,a)=>h.value[a],fontSize:14*l.value,color:o.info.style.fontColor,fontFamily:"robo"},axisLine:{show:!1},axisPointer:{type:"shadow",shadowStyle:{color:new k.graphic.LinearGradient(0,0,0,1,[{offset:0,color:"#fff"},{offset:1,color:"rgba(255, 255, 255, .0)"}],!1),opacity:.3}},data:h.value.map(e=>e===d.value?{value:e,textStyle:{color:"#fff",padding:[2*l.value,6*l.value],borderWidth:1*l.value,borderRadius:2*l.value,borderColor:o.info.style.fontColor,backgroundColor:new k.graphic.LinearGradient(0,0,0,1,[{offset:0,color:"#1F3A5F"},{offset:1,color:"#acc2ef"}],!1)}}:{value:e,textStyle:{color:"#fff",padding:[2*l.value,6*l.value]}})},yAxis:{type:"value",min:0,max:o.info.splitNumber*f.value,interval:f.value,splitNumber:o.info.splitNumber,splitLine:{show:!0,lineStyle:{color:"rgba(255, 255, 255, 0.25)"}},axisLabel:{show:!1,fontSize:14*l.value,color:o.info.style.fontColor}},series:((t=o.data)==null?void 0:t.map(e=>({...e,type:"line",symbol:"circle",showSymbol:!0,smooth:!0,connectNulls:!0,lineStyle:{color:e.color,width:2*l.value},areaStyle:{color:{type:"linear",x:0,y:0,x2:0,y2:1,colorStops:e.colorStops.map((a,m)=>({offset:m,color:a})),global:!1}},data:e.data})))||[]}},p=n(null),g=n(null),b=n(null);z(b,t=>{if(!t)return;const e=t[0],{width:a}=e.contentRect;g.value.style.left=a+8*l.value+"px",p.value.onResize()}),I(()=>{x(),p.value.myChart.on("highlight",({batch:[{dataIndex:t}]})=>{d.value=o.data[0].data[t].name||o.data.data[t]}),p.value.myChart.on("downplay",()=>d.value=""),S.value=[`<script setup>
...
</style>`],v.value={...v.value,type:"vue",activeIndex:0}}),T(()=>{S.value=[""],v.value={...v.value,type:"javascript",activeIndex:0}}),j(()=>[o.data,d.value],()=>{x()},{deep:!0});const F=t=>{const e=f.value,a=e>1||e===1?(t-1)*e:((t-1)*e).toFixed(1);return a==="0.0"?"0":a};return(t,e)=>{const a=M,m=L;return r(),s("div",V,[w(m,null,{default:G(()=>[u.data.length?(r(),s("div",D,[u.info.titleShow?(r(),s("div",U,[c("div",B,_(u.info.yName),1),c("div",q,[(r(!0),s(N,null,R(u.data,i=>(r(),s("div",{key:i.name,class:"title__legend__item"},[c("span",{class:"title__legend__item__icon",style:P({backgroundColor:i.color})},null,4),c("span",E,_(i.name),1)]))),128))])])):C("",!0),c("div",$,[c("ul",{ref_key:"yAxixRef",ref:b,class:"content__x-axis"},[(r(!0),s(N,null,R(u.info.splitNumber+1,i=>(r(),s("li",{key:i},_(F(i)),1))),128))],512),c("div",{ref_key:"myChartRef",ref:g},[w(a,{class:"content__canvas",ref_key:"chartRef",ref:p,option:W(y)},null,8,["option"])],512)])])):C("",!0)]),_:1})])}}},te=O(H,[["__scopeId","data-v-e38ff938"]]);export{te as default};
