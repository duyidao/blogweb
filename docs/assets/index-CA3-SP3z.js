...
[04:52.899]`,F0="/blogweb/assets/likeme-BI0z1bw6.mp3",Y0=`[00:00.000] 作词 : 毛不易
[00:01.000] 作曲 : 毛不易
[00:02.000] 编曲 : 赵兆/宋涛
[00:03.000] 制作人 : 李健/赵兆
[00:09.840]
...
[03:27.421] 制作发行 : 哇唧唧哇
`,N0="/blogweb/assets/peter-BVhB60oM.mp3",V0="/blogweb/assets/shape-Dr8ic4LH.mp3",q0="/blogweb/assets/so_far_away-CPeEg5z6.mp3",Q0=`[00:00.00]So Far Away - Martin Garrix/David Guetta/Jamie Scott/Romy Dya
...
[02:58.53]When you're so far away`,U0="/blogweb/assets/so%20far%20away-Dl1oEphr.webp",X0="/blogweb/assets/something-CLtHNr96.mp3",K0=`[ml:1.0]
...
[03:56.044]我想要的不过是这些
[03:56.044]`,Z0="/blogweb/assets/something-f5Ei2QHr.webp",ee={__name:"music",setup(t){const o=i(null),a=i(null);return k(()=>{a.value=new APlayer({container:o.value,lrcType:1,theme:$.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:J0,lrc:R0,cover:a0},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:N0,cover:d0},{name:"Shape of You",artist:"Ed Sheeran",url:V0,cover:o0},{name:"像我这样的人",artist:"毛不易",url:F0,lrc:Y0,cover:e0},{name:"So far away",artist:"Martin Garrix",url:q0,lrc:Q0,cover:U0},{name:"Something just like this",artist:"The Chainsmokers",url:X0,lrc:K0,cover:Z0}]})}),X(()=>$.value,()=>{a.value.audio.theme=$.value?"#fff":"#555"}),(d,u)=>(w(),v("div",{ref_key:"musicRef",ref:o,class:"home-music"},null,512))}},ae=S(ee,[["__scopeId","data-v-fb87f208"]]),oe={class:"home"},de={class:"msg"},ne={class:"play"},ce={class:"box"},te={class:"home-candle"},se={class:"home-time"},me={__name:"index",setup(t){const o=i(null),a=i(""),d=i(""),u=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],g=i("");return k(()=>{let n=new Date;const y=n.getDay();a.value=n.getFullYear()+"-"+("0"+(n.getMonth()+1)).slice(-2)+"-"+("0"+n.getDate()).slice(-2),g.value=u[y];const _=()=>{n=new Date;const T=("0"+n.getHours()).slice(-2),D=("0"+n.getMinutes()).slice(-2),C=("0"+n.getSeconds()).slice(-2);d.value=T+":"+D+":"+C};_(),o.value=setInterval(()=>{_()},1e3)}),P(()=>{clearInterval(o.value)}),(n,y)=>(w(),v("div",oe,[I(z0,{class:"user"}),e("div",de,[I(L0),e("div",ne,[e("div",ce,[e("div",te,[I(Z)]),e("div",se,[e("span",null,s(c(a)),1),e("span",null,s(c(g)),1),e("span",null,s(c(d)),1)])]),I(ae)])])]))}},ve=S(me,[["__scopeId","data-v-7435f903"]]);export{ve as default};
