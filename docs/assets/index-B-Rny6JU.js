import{_ as c}from"./index-gMdTY4AK.js";import{g as d,l as f}from"./index-B7ij133t.js";import{s as g,o as t,c as o,F as u,f as v,h as n,w as h,i as p,u as R}from"./index-Ct9s1DbM.js";import"./index-BUQgu8J8.js";import"./index-CALvWwPD.js";const b={class:"iframe-box box"},U={__name:"index",setup(x){const i={compressCode:`const imgUrl = ref('')
    const imgInfo = ref({
      size: 0,
      blobsize: 0
    })
...
}`},s=d("learn.canvas"),l=g([]);return l.value=s.map(a=>({...a,model:i[a.name+"Code"],component:Object.freeze(f.value[a.name])})),(a,C)=>{const m=c;return t(),o("div",b,[(t(!0),o(u,null,v(R(l),e=>(t(),n(m,{key:e.name,title:e.title,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",modelValue:e.model,"onUpdate:modelValue":r=>e.model=r,type:"javascript",disabled:""},{default:h(()=>[(t(),n(p(e.component)))]),_:2},1032,["title","modelValue","onUpdate:modelValue"]))),128))])}}};export{U as default};
