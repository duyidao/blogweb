...
}`]}),b(()=>{f.value=[""]}),(i,n)=>{const r=x;return d(),F(r,{title:"input组件封装",flowImg:l(w),class:"input-info"},{default:B(()=>[u("div",k,[u("span",A,"文本输入框，父组件内容 "+c(l(e)),1),m(g,{msg:l(e),"onUpdate:msg":n[0]||(n[0]=o=>p(e)?e.value=o:null)},null,8,["msg"])]),u("div",C,[u("span",U,"多行文本框，父组件内容 "+c(l(e)),1),m(g,{type:"textarea",msg:l(e),"onUpdate:msg":n[1]||(n[1]=o=>p(e)?e.value=o:null)},null,8,["msg"])]),u("div",V,[u("span",E,"数字框，父组件内容 "+c(l(t)),1),m(g,{type:"number",msg:l(t),"onUpdate:msg":n[2]||(n[2]=o=>p(t)?t.value=o:null)},null,8,["msg"])])]),_:1},8,["flowImg"])}}},O=_($,[["__scopeId","data-v-9198a73a"]]);export{O as default};
