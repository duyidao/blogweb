import{_ as C}from"./index-GrhpAljX.js";import{c as g}from"./effect-BKCwPZM9.js";import{_ as S}from"./index-Du2CWlgG.js";import{u as $}from"./rem-xC5CoqQM.js";import{_ as F,r as v,q as w,x as M,P as l,M as y,o as x,h as I,u as _,w as j,j as A}from"./index-DiFe4JqO.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=$(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
