...
[04:52.899]`,E0="/blogweb/assets/likeme-BI0z1bw6.mp3",z0=`[00:00.000] 作词 : 毛不易
[00:01.000] 作曲 : 毛不易
[00:02.000] 编曲 : 赵兆/宋涛
[00:03.000] 制作人 : 李健/赵兆
[00:09.840]
...
[03:27.421] 制作发行 : 哇唧唧哇
`,P0="/blogweb/assets/peter-BVhB60oM.mp3",J0="/blogweb/assets/shape-Dr8ic4LH.mp3",R0="/blogweb/assets/so_far_away-CPeEg5z6.mp3",Y0=`[00:00.00]So Far Away - Martin Garrix/David Guetta/Jamie Scott/Romy Dya
...
[02:58.53]When you're so far away`,F0="/blogweb/assets/so%20far%20away-Dl1oEphr.webp",N0="/blogweb/assets/something-CLtHNr96.mp3",V0=`[ml:1.0]
...
[03:56.044]我想要的不过是这些
[03:56.044]`,q0="/blogweb/assets/something-f5Ei2QHr.webp",Q0={__name:"music",setup(d){const a=p(null),o=p(null);return D(()=>{o.value=new V({container:a.value,lrcType:1,theme:C.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:H0,lrc:j0,cover:K},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:P0,cover:e0},{name:"Shape of You",artist:"Ed Sheeran",url:J0,cover:Z},{name:"像我这样的人",artist:"毛不易",url:E0,lrc:z0,cover:X},{name:"So far away",artist:"Martin Garrix",url:R0,lrc:Y0,cover:F0},{name:"Something just like this",artist:"The Chainsmokers",url:N0,lrc:V0,cover:q0}]})}),q(()=>C.value,()=>{o.value.audio.theme=C.value?"#fff":"#555"}),(c,y)=>(f(),I("div",{ref_key:"musicRef",ref:a,class:"home-music"},null,512))}},U0=T(Q0,[["__scopeId","data-v-efc38a27"]]),X0={class:"home"},K0={class:"msg"},Z0={class:"play"},ee={class:"box"},ae={class:"home-candle"},oe={class:"home-time"},de={__name:"index",setup(d){const a=p(null),o=p(""),c=p(""),y=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],g=p("");return D(()=>{let n=new Date;const _=n.getDay();o.value=n.getFullYear()+"-"+("0"+(n.getMonth()+1)).slice(-2)+"-"+("0"+n.getDate()).slice(-2),g.value=y[_];const s=()=>{n=new Date;const t=("0"+n.getHours()).slice(-2),m=("0"+n.getMinutes()).slice(-2),i=("0"+n.getSeconds()).slice(-2);c.value=t+":"+m+":"+i};s(),a.value=setInterval(()=>{s()},1e3)}),j(()=>{clearInterval(a.value)}),(n,_)=>(f(),I("div",X0,[k(L0,{class:"user"}),e("div",K0,[k($0),e("div",Z0,[e("div",ee,[e("div",ae,[k(U)]),e("div",oe,[e("span",null,h(r(o)),1),e("span",null,h(r(g)),1),e("span",null,h(r(c)),1)])]),k(U0)])])]))}},ue=T(de,[["__scopeId","data-v-7435f903"]]);export{ue as default};
