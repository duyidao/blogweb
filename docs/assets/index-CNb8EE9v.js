import{_ as C}from"./index-BncObdK2.js";import{c as g}from"./effect-vUu9Uqgv.js";import{_ as S}from"./index-vNyc_gD2.js";import{u as $}from"./rem-DTVwtWVW.js";import{_ as F,r as v,q as w,x as M,P as l,M as y,o as x,h as I,u as _,w as j,j as A}from"./index-iiNFdt9r.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=$(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
