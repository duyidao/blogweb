import{_ as C}from"./index-COgIaLxX.js";import{c as g}from"./effect-zC7zcSRU.js";import{_ as S}from"./index-BbnUMaBG.js";import{_ as $,Q as F,r as v,v as w,y as j,S as l,O as y,o as x,h as I,u as _,w as A,j as M}from"./index-ZQOAdrIW.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=F(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
