import{_ as i}from"./index-gMdTY4AK.js";import{g as d,l as f}from"./index-B7ij133t.js";import{_ as p,s as m,o,c as l,F as x,f as h,h as s,w as _,i as b,u as w}from"./index-Ct9s1DbM.js";import"./index-BUQgu8J8.js";import"./index-CALvWwPD.js";const v={class:"iframe-box xlsx-word"},C={__name:"index",setup(F){const a={xlsxCode:`import { read, utils } from "xlsx";
...
}`},r=d("learn.xlsxAndWord"),n=m([]);return n.value=r.map(t=>({...t,model:a[t.name+"Code"],component:Object.freeze(f.value[t.name])})),(t,g)=>{const c=i;return o(),l("div",v,[(o(!0),l(x,null,h(w(n),e=>(o(),s(c,{key:e.name,title:e.title,subtitle:e.subtitle,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",modelValue:e.model,"onUpdate:modelValue":u=>e.model=u,type:"javascript",height:"500",disabled:"",column:""},{default:_(()=>[(o(),s(b(e.component)))]),_:2},1032,["title","subtitle","modelValue","onUpdate:modelValue"]))),128))])}}},L=p(C,[["__scopeId","data-v-6d6d4b35"]]);export{L as default};
