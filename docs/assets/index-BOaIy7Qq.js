import{_ as C}from"./index-CM9OeQjf.js";import{c as g}from"./effect-CO1aAAXF.js";import{_ as S}from"./index-KWvF1owq.js";import{u as $}from"./rem-CbSUZWA8.js";import{_ as F,r as v,q as w,x as M,P as l,M as y,o as x,h as I,u as _,w as j,j as A}from"./index-Sw9qLz3T.js";const W={__name:"pieChart",props:{data:{type:Array,default:()=>[]}},setup(c,{expose:p}){const n=c,r=new Map,{ratio:a}=$(),m=v({}),b=()=>{m.value={tooltip:{trigger:"item",formatter:e=>`<div>
        <div>
