import{_ as i}from"./index-C8SelH6X.js";import{_ as d,g as f,s as p,Y as m,o,c as l,F as x,j as h,k as s,w as _,u as b,l as w}from"./index-B4bBUjY3.js";import"./index-CKO9WkJI.js";const v={class:"iframe-box xlsx-word"},C={__name:"index",setup(F){const a={xlsxCode:`import { read, utils } from "xlsx";
...
}`},r=f("learn.xlsxAndWord"),n=p([]);return n.value=r.map(t=>({...t,model:a[t.name+"Code"],component:Object.freeze(m.value[t.name])})),(t,g)=>{const c=i;return o(),l("div",v,[(o(!0),l(x,null,h(b(n),e=>(o(),s(c,{key:e.name,title:e.title,subtitle:e.subtitle,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",modelValue:e.model,"onUpdate:modelValue":u=>e.model=u,type:"javascript",height:"500",disabled:"",column:""},{default:_(()=>[(o(),s(w(e.component)))]),_:2},1032,["title","subtitle","modelValue","onUpdate:modelValue"]))),128))])}}},y=d(C,[["__scopeId","data-v-eddc79af"]]);export{y as default};
