...
[04:52.899]`,Y0="/blogweb/assets/likeme-BI0z1bw6.mp3",N0=`[00:00.000] 作词 : 毛不易
[00:01.000] 作曲 : 毛不易
[00:02.000] 编曲 : 赵兆/宋涛
[00:03.000] 制作人 : 李健/赵兆
[00:09.840]
...
[03:27.421] 制作发行 : 哇唧唧哇
`,V0="/blogweb/assets/peter-BVhB60oM.mp3",q0="/blogweb/assets/shape-Dr8ic4LH.mp3",Q0="/blogweb/assets/so_far_away-CPeEg5z6.mp3",U0=`[00:00.00]So Far Away - Martin Garrix/David Guetta/Jamie Scott/Romy Dya
...
[02:58.53]When you're so far away`,X0="/blogweb/assets/so%20far%20away-Dl1oEphr.webp",K0="/blogweb/assets/something-CLtHNr96.mp3",Z0=`[ml:1.0]
...
[03:56.044]我想要的不过是这些
[03:56.044]`,ee="/blogweb/assets/something-f5Ei2QHr.webp",ae={__name:"music",setup(d){const o=i(null),a=i(null);return k(()=>{t0().then(n=>{a.value=new APlayer({container:o.value,lrcType:1,theme:$.value?"#fff":"#555",audio:[{name:"杀死那个石家庄人",artist:"万能青年旅店",url:R0,lrc:F0,cover:a0},{name:"Peter Pan Was Right",artist:"Anson Seabra",url:V0,cover:d0},{name:"Shape of You",artist:"Ed Sheeran",url:q0,cover:o0},{name:"像我这样的人",artist:"毛不易",url:Y0,lrc:N0,cover:e0},{name:"So far away",artist:"Martin Garrix",url:Q0,lrc:U0,cover:X0},{name:"Something just like this",artist:"The Chainsmokers",url:K0,lrc:Z0,cover:ee}]})})}),X(()=>$.value,()=>{a.value.audio.theme=$.value?"#fff":"#555"}),(n,r)=>(w(),v("div",{ref_key:"musicRef",ref:o,class:"home-music"},null,512))}},oe=S(ae,[["__scopeId","data-v-9708a837"]]),de={class:"home"},ne={class:"msg"},ce={class:"play"},te={class:"box"},se={class:"home-candle"},me={class:"home-time"},ie={__name:"index",setup(d){const o=i(null),a=i(""),n=i(""),r=["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],l=i("");return k(()=>{let c=new Date;const y=c.getDay();a.value=c.getFullYear()+"-"+("0"+(c.getMonth()+1)).slice(-2)+"-"+("0"+c.getDate()).slice(-2),l.value=r[y];const _=()=>{c=new Date;const T=("0"+c.getHours()).slice(-2),C=("0"+c.getMinutes()).slice(-2),D=("0"+c.getSeconds()).slice(-2);n.value=T+":"+C+":"+D};_(),o.value=setInterval(()=>{_()},1e3)}),W(()=>{clearInterval(o.value)}),(c,y)=>(w(),v("div",de,[I(J0,{class:"user"}),e("div",ne,[I(L0),e("div",ce,[e("div",te,[e("div",se,[I(Z)]),e("div",me,[e("span",null,s(t(a)),1),e("span",null,s(t(l)),1),e("span",null,s(t(n)),1)])]),I(oe)])])]))}},_e=S(ie,[["__scopeId","data-v-7435f903"]]);export{_e as default};
