import{_ as c}from"./index-DjaZ8iea.js";import{g as d,s as f,Y as g,o as t,c as o,F as u,j as v,k as n,w as h,u as p,l as R}from"./index-BoT65t34.js";const b={class:"iframe-box box"},D={__name:"index",setup(x){const i={compressCode:`const imgUrl = ref('')
    const imgInfo = ref({
      size: 0,
      blobsize: 0
    })
...
}`},s=d("learn.canvas"),l=f([]);return l.value=s.map(a=>({...a,model:i[a.name+"Code"],component:Object.freeze(g.value[a.name])})),(a,w)=>{const m=c;return t(),o("div",b,[(t(!0),o(u,null,v(p(l),e=>(t(),n(m,{key:e.name,title:e.title,buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",modelValue:e.model,"onUpdate:modelValue":r=>e.model=r,type:"javascript",disabled:""},{default:h(()=>[(t(),n(R(e.component)))]),_:2},1032,["title","modelValue","onUpdate:modelValue"]))),128))])}}};export{D as default};
