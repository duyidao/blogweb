import{_ as f}from"./index-DuxcDr6X.js";import{_ as v}from"./index-BZdvKOLU.js";import{_ as g,r as s,q as p,N as w,o as x,c as R,j as c,w as C,a as t,E as u,u as d,B as U,T as I}from"./index-85zvVEea.js";import{c as _}from"./effect-BQD-t1IR.js";import"./index-B-nIsSiX.js";const k={class:"iframe-box box"},B={class:"tailor"},F={class:"tailor-upload"},N=["src"],T={__name:"index",setup(y){const o=s(""),i=s(null),e=s(null),m=r=>{let a=new FileReader;a.readAsDataURL(r),a.onload=()=>{o.value=a.result;let n=i.value.getContext("2d");setTimeout(()=>{let l=100/e.value.height*e.value.naturalHeight,h=200/e.value.width*e.value.naturalWidth;n.drawImage(e.value,0,0,h,l,0,0,200,100)},1e3)}};return p(()=>{_.value=[`const onChangeFn = e => {
  // 预览文件
