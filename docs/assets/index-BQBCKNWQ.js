import{_ as d}from"./index-D4O1AoeG.js";import{_ as f,r as a,o as c,h as m,w as _,a as p,D as y,u as n,c as v,E as b,N as C,k}from"./index-DSusb5t4.js";import"./index-CmFlYRr_.js";import"./index-DAF7Z3eN.js";const w={__name:"index",setup(x){const e=a(""),l=a(null),u=()=>{if(!window.EyeDropper){e.value="你的浏览器不支持 EyeDropper API",l.value.style.backgroundColor="#000";return}e.value="正在打开拾色器，请稍等...";const s=new EyeDropper,r=new AbortController;s.open({signal:r.signal}).then(o=>{e.value=o.sRGBHex,l.value.style.backgroundColor=o.sRGBHex}).catch(o=>{e.value=o})},t=a(`const clickFn = () => {
  // 判断浏览器是否支持
