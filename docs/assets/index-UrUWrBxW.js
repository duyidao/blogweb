...
const setImgFileEmptyFn = () => {
  ...
  originImgSrc.value = ''
}`);return(e,a)=>{const t=k,o=O;return v(),V(o,{title:"图片压缩",subtitle:"请选择jpg格式图片",class:"iframe-box",buttonTitle:"源码展示",showCodeButtonTitle:"隐藏源码",column:"",type:"javascript",modelValue:m(p),"onUpdate:modelValue":a[0]||(a[0]=d=>T(p)?p.value=d:null),disabled:""},{default:B(()=>[N(t,{id:"imgFile",placeholder:"请选择图片",ref_key:"imgFile",ref:I,onChange:x},null,512),c("div",H,[c("div",L,[M,m(s)?(v(),F("img",{key:0,src:m(s),title:"未压缩",alt:"未压缩"},null,8,W)):S("",!0)]),c("div",G,[Y,m(l)?(v(),F("img",{key:0,src:m(l),title:"压缩后",alt:"压缩后"},null,8,A)):S("",!0)])])]),_:1},8,["modelValue"])}}},Z=R($,[["__scopeId","data-v-4eab2deb"]]);export{Z as default};
